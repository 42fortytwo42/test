...
`normalMap` can me mixed with `specularMap` ([Working with specular maps](doc/Working_with_specular_maps_.md)) and/or `environmentMap` ([Working with environment maps ](doc/Working_with_environment_maps_.md)) to produce great effect on your 3D models: [ PhongMaterial reference full example](PhongMaterial reference#Full_Example).
