In this tutorial, we will introduce how to work with the `PhongMaterial` to achieve lights dependent rendering. In order to fully understand this example, please read this one first : [Working with the BasicMaterial](doc/Working_with_the_BasicMaterial.md)
...
-   directional light: [Working with directional lights](doc/Working_with_directional_lights.md)
-   spot light: [Working with spot lights](doc/Working_with_spot_lights.md)
-   point light: [Working with point lights](doc/Working_with_point_lights.md)
...
-   `PhongMaterial::diffuseMap(AbstractTexture::Ptr texture)` [Loading and using textures](doc/Loading_and_using_textures.md)
...
-   [ Working with normal maps ](doc/Working_with_normal_maps_.md)
