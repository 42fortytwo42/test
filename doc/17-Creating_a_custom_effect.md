...
Here, we've declared a (vertex) attribute and 3 uniforms. The attribute should be filled properly thanks to the attributeBindings declared in our *.effect file. We don't know yet how it works exactly but it should work. Yet, our uniforms don't have a value and no bindings declared: we will have to set them at runtime when our effect is loaded.
